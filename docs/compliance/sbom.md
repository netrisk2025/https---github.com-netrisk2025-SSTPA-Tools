...
| go | cloud.google.com/go/compute/metadata | v0.9.0 | Apache-2.0 | backend/go.mod |
...
| go | github.com/alecthomas/kingpin/v2 | v2.4.0 | MIT | backend/go.mod |
| go | github.com/alecthomas/units | v0.0.0-20211218093645-b94a6e3cc137 | MIT | backend/go.mod |
| go | github.com/antihax/optional | v1.0.0 | MIT | backend/go.mod |
| go | github.com/Azure/go-ansiterm | v0.0.0-20250102033503-faa5f7b0171c | MIT | backend/go.mod |
| go | github.com/beorn7/perks | v1.0.1 | MIT | backend/go.mod |
| go | github.com/cenkalti/backoff/v4 | v4.3.0 | MIT | backend/go.mod |
| go | github.com/cenkalti/backoff/v5 | v5.0.3 | MIT | backend/go.mod |
| go | github.com/cespare/xxhash/v2 | v2.3.0 | MIT | backend/go.mod |
| go | github.com/cncf/xds/go | v0.0.0-20251210132809-ee656c7534f5 | Apache-2.0 | backend/go.mod |
...
| go | github.com/envoyproxy/go-control-plane | v0.14.0 | Apache-2.0 | backend/go.mod |
| go | github.com/envoyproxy/go-control-plane/envoy | v1.36.0 | Apache-2.0 | backend/go.mod |
| go | github.com/envoyproxy/go-control-plane/ratelimit | v0.1.0 | Apache-2.0 | backend/go.mod |
| go | github.com/envoyproxy/protoc-gen-validate | v1.3.0 | Apache-2.0 | backend/go.mod |
| go | github.com/felixge/httpsnoop | v1.0.4 | MIT | backend/go.mod |
| go | github.com/go-chi/chi/v5 | v5.2.1 | MIT | backend/go.mod |
| go | github.com/go-jose/go-jose/v4 | v4.1.3 | Apache-2.0 | backend/go.mod |
...
| go | github.com/golang/glog | v1.2.5 | Apache-2.0 | backend/go.mod |
| go | github.com/golang/protobuf | v1.5.4 | BSD-3-Clause | backend/go.mod |
...
| go | github.com/GoogleCloudPlatform/opentelemetry-operations-go/detectors/gcp | v1.31.0 | Apache-2.0 | backend/go.mod |
| go | github.com/grpc-ecosystem/grpc-gateway/v2 | v2.28.0 | BSD-3-Clause | backend/go.mod |
| go | github.com/jpillora/backoff | v1.0.0 | MIT | backend/go.mod |
| go | github.com/json-iterator/go | v1.1.12 | MIT | backend/go.mod |
| go | github.com/julienschmidt/httprouter | v1.3.0 | BSD-3-Clause | backend/go.mod |
...
| go | github.com/kylelemons/godebug | v1.1.0 | Apache-2.0 | backend/go.mod |
...
| go | github.com/modern-go/concurrent | v0.0.0-20180306012644-bacd9c7ef1dd | Apache-2.0 | backend/go.mod |
| go | github.com/modern-go/reflect2 | v1.0.2 | Apache-2.0 | backend/go.mod |
| go | github.com/morikuni/aec | v1.0.0 | MIT | backend/go.mod |
| go | github.com/munnerz/goautoneg | v0.0.0-20191010083416-a7dc8b61c822 | BSD-3-Clause | backend/go.mod |
| go | github.com/mwitkow/go-conntrack | v0.0.0-20190716064945-2f068394615f | Apache-2.0 | backend/go.mod |
...
| go | github.com/prometheus/client_golang | v1.23.2 | Apache-2.0 | backend/go.mod |
| go | github.com/prometheus/client_model | v0.6.2 | Apache-2.0 | backend/go.mod |
| go | github.com/prometheus/common | v0.66.1 | Apache-2.0 | backend/go.mod |
| go | github.com/prometheus/procfs | v0.16.1 | Apache-2.0 | backend/go.mod |
| go | github.com/rogpeppe/fastuuid | v1.2.0 | BSD-3-Clause | backend/go.mod |
...
| go | github.com/spiffe/go-spiffe/v2 | v2.6.0 | Apache-2.0 | backend/go.mod |
...
| go | github.com/xhit/go-str2duration/v2 | v2.1.0 | BSD-3-Clause | backend/go.mod |
...
| go | go.opentelemetry.io/contrib/detectors/gcp | v1.39.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp | v0.60.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/otel | v1.43.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/otel/exporters/otlp/otlptrace | v1.43.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp | v1.43.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/otel/metric | v1.43.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/otel/sdk | v1.43.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/otel/sdk/metric | v1.43.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/otel/trace | v1.43.0 | Apache-2.0 | backend/go.mod |
| go | go.opentelemetry.io/proto/otlp | v1.10.0 | Apache-2.0 | backend/go.mod |
| go | go.uber.org/goleak | v1.3.0 | MIT | backend/go.mod |
| go | go.yaml.in/yaml/v2 | v2.4.2 | Apache-2.0 | backend/go.mod |
| go | go.yaml.in/yaml/v3 | v3.0.4 | Apache-2.0 | backend/go.mod |
| go | golang.org/x/crypto | v0.49.0 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/mod | v0.33.0 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/mod | v0.21.0 | BSD-3-Clause | tools/reference-pipeline/go.mod |
| go | golang.org/x/net | v0.52.0 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/oauth2 | v0.35.0 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/sync | v0.20.0 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/sys | v0.42.0 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/sys | v0.26.0 | BSD-3-Clause | tools/reference-pipeline/go.mod |
| go | golang.org/x/term | v0.41.0 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/text | v0.35.0 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/time | v0.0.0-20220210224613-90d013bbcef8 | BSD-3-Clause | backend/go.mod |
| go | golang.org/x/tools | v0.42.0 | BSD-3-Clause | backend/go.mod |
...
| go | gonum.org/v1/gonum | v0.17.0 | BSD-3-Clause | backend/go.mod |
| go | google.golang.org/genproto/googleapis/api | v0.0.0-20260401024825-9d38bb4040a9 | Apache-2.0 | backend/go.mod |
| go | google.golang.org/genproto/googleapis/rpc | v0.0.0-20260401024825-9d38bb4040a9 | Apache-2.0 | backend/go.mod |
| go | google.golang.org/grpc | v1.80.0 | Apache-2.0 | backend/go.mod |
| go | google.golang.org/protobuf | v1.36.11 | BSD-3-Clause | backend/go.mod |
